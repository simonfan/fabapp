...
define('fabapp/view/base',['require','exports','module','jquery-selector-data-prefix','bbdv'],function defBaseFabappView(require, exports, module) {
	...
	baseFabappView.directive('invoke', function ($el, modName) {
...
define('fabapp/view/display',['require','exports','module','lodash','q','jquery','fabapp/view/base'],function defVisualizationView(require, exports, module) {
...
define('text!fabapp/index.html',[],function () { return '<div class="fabapp">\n\n\n\t<div class="header">\n\t\tAPP MAIN\n\t</div>\n\n\t<div data-fab-invoke="fabapp/view/display"></div>\n\n\n</div>\n';});
...
define('fabapp',['require','exports','module','fabapp/view/display','fabapp/view/base','text!fabapp/index.html'],function (require, exports, module) {
	...
	var fabapp = view.extend({
		...
		template: require('text!fabapp/index.html')
	});
